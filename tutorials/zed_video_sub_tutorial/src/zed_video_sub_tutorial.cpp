...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber subRightRectified =
      n.subscribe("/zed2/zed_node/right/image_rect_color", 10, imageRightRectifiedCallback);
  ros::Subscriber subLeftRectified = n.subscribe("/zed2/zed_node/left/image_rect_color", 10, imageLeftRectifiedCallback);
